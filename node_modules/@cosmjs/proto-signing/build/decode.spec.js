...
describe("decode", () => {
    describe("decodeTxRaw", () => {
        it("works", () => {
            const pubkeyBytes = encoding_1.fromBase64(testutils_spec_1.faucet.pubkey.value);
            ...
            const decoded = decode_1.decodeTxRaw(encoding_1.fromHex(testVector.outputs.signedTxBytes));
            expect(decoded).toEqual({
                ...
                signatures: [encoding_1.fromHex(testVector.outputs.signature)],
            });
        });
    });
});
